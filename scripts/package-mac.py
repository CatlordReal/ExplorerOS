...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="package-", dir=output) as temporary:
        ...
        for name in ["FIRMWARE-BUNDLE.md", "FIRMWARE-INTEGRATION.md", "FIRMWARE-AUDIT.md", "IPHONE-FIRMWARE-OPTIONS.md", "VALIDATION.md", "UPSTREAM-INSTALLER.md", "FLASHING.md", "COMMUNITY-SAFETY.md", "MEDIA-SYNC.md", "GLASS.md", "HARDWARE.md", "INTEGRATIONS.md", "FEASIBILITY-HFP.md"]:
